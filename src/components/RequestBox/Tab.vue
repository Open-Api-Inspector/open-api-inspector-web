<template>
  <div class="py-10">
    <div class="container mx-auto">
      ...
      <div
        class="xl:w-full xl:mx-0 h-12 hidden sm:block bg-white shadow rounded"
      >
        <ul class="flex border-b px-5">
          <li
            @click="activeTab($event)"
            class="text-sm border-indigo-700 pt-3 rounded-t text-indigo-700 mr-12 cursor-pointer"
          >
          ...
          <li
            @click="activeTab($event)"
            class="text-sm border-indigo-700 pt-3 rounded-t text-gray-600 mr-12 hover:text-indigo-700 cursor-pointer"
          >
            <div class="flex items-center mb-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
